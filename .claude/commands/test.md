...
3. `pytest tests/test_mcp.py tests/test_cookies_unit.py tests/test_testclient.py tests/test_async_isolation.py tests/test_logging.py -v` — pytest unit tests
